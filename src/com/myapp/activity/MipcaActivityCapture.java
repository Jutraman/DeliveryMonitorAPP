...
import com.android.zxing.decoding.CaptureActivityHandler;
import com.android.zxing.decoding.InactivityTimer;
import com.android.zxing.decoding.RGBLuminanceSource;
...
public class MipcaActivityCapture extends Activity implements Callback {
	...
	private void onResultHandler(String resultString, Bitmap bitmap) {
		...
		/*
		 * Intent intent = new
		 * Intent(MipcaActivityCapture.this,ResultActivity.class);//在结果页显示
		 * Bundle bundle = new Bundle(); bundle.putString("result",
		 * resultString); bundle.putParcelable("bitmap", bitmap);
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		if (resultString.equals("")) {
			Toast.makeText(MipcaActivityCapture.this, "逗比，你扫的二维码坏了",
					Toast.LENGTH_SHORT).show();
		} else {
